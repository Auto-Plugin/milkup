...
export const defaultFontSizeConfig: FontSizeConfig = {
  ...
  "code-font-size": "16px",
  "editor-font-size-h1": "32px",
  "editor-font-size-h2": "28px",
  "editor-font-size-h3": "24px",
  "editor-font-size-h4": "20px",
  "editor-font-size-h5": "18px",
  "editor-font-size-h6": "16px",
};

export const legacyDefaultFontSizeConfig: FontSizeConfig = {
  "editor-font-size": "16px",
  "code-font-size": "16px",
